    ...
    return showCart && ReactDOM.createPortal(
        <>
            <div className='fixed z-10 inset-0 bg-black opacity-90'>
                <div className=" fixed top-1/3 right-72 p-3 transform -translate-x-1/2 -translate-y-1/2 my-auto w-screen  max-w-96 rounded-lg  text-black bg-slate-50 shadow-lg border-2">
