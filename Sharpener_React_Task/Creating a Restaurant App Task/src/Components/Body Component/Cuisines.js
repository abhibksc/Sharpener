...
const Cuisines = () => {
    ...
    const { arr, Cart_Count, setCart_Count, Bill, setBill, CartItems, setCartItems } = useContext(Context);
    ...
    const handleForm = (e, items) => {
        ...
        if (e.target[0].value > 0) {
            ...
            let total_item = items.total + Bill;
            setBill(total_item);
    ...
    return (
        <div className="bg-gray-700 relative top-28">
